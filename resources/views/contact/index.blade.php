...
@section('content')
<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(landing/images/heading-pages-06.jpg);">
				...
				<div class="col-md-6 p-b-30">
					...
					@csrf
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="customer_name" placeholder="Full Name">
						</div>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="title" placeholder="Title">
						</div>
